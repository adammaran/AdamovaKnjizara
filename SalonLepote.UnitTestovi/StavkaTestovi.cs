using System;
using Cenovnik.Podaci;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace Cenovnik.UnitTestovi
{
    [TestClass]
    public class StavkaTestovi
    {
        ...
        public void Testiranje_Konstruktora_Sa_Null_Nazivom_Baca_ArgumentException()
        {
            ...
            //Act
            //Assert
            Assert.ThrowsException<ArgumentException>(() => new Stavka(id, naziv, cena, kategorija));
        }
        ...
        public void Testiranje_Konstruktora_Sa_Null_Kategorijom_Baca_ArgumentNullException()
        {
            ...
            //Act
            //Assert
            Assert.ThrowsException<ArgumentNullException>(() => new Stavka(id, naziv, cena, kategorija));
        }
    }
}
