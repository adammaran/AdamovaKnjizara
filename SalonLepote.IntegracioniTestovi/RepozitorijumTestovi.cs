...
namespace SalonLepote.IntegracioniTestovi
{
    [TestClass]
    public class RepozitorijumTestovi
    {
        ...
        public void InicijalnaPodestavanja()
        {
            ...
            using (IDbConnection konekcija = _db.KonekcijaKaBazi())
            {
                ...
                using (IDbCommand komanda = konekcija.CreateCommand())
                {
                    ...
                    komanda.CommandText = "INSERT INTO Usluga(Id, Naziv, Cena, Kategorija) VALUES(@Id, 'TestUsluga', 20.0, @Id)";
        ...
        public void BrisanjePosleTesta()
        {
            using (IDbConnection konekcija = _db.KonekcijaKaBazi())
            {
                ...
                using (IDbCommand komanda = konekcija.CreateCommand())
                {
                    komanda.CommandText = "DELETE FROM Usluga";
                    komanda.ExecuteNonQuery();
        ...
        [TestMethod]
        public void Testiranje_DajSve_Vraca_Listu_Usluga()
        {
            //Arrange
            List<Knjiga> lista;
            int ocekivana_velicina_liste = 1;
            string ocekivani_naziv_usluge = "TestUsluga";
        ...
        [TestMethod]
        public void Testiranje_DajPoId_Sa_Postojecim_Id_Vraca_Uslugu()
        {
            //Arrange
            Knjiga usluga;
        ...
        [TestMethod]
        public void Testiranje_Dodaj_Dodaje_Stavku_U_Bazu()
        {
            //Arrange
            Knjiga knjiga = new Knjiga(Guid.NewGuid(), "TestStavka2", 10.0, new Kategorija(new Guid("00000000-0000-0000-0000-000000000001"), "TestKategorija"));
            List<Knjiga> podaci;
