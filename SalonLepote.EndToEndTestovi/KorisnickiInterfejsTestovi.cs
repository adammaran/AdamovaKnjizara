...
namespace SalonLepote.EndToEndTestovi
{
    [TestClass]
    public class KorisnickiInterfejsTestovi
    {
        ...
        {
            //Arrange
            IWebElement homeBtn = _driver.FindElement(By.LinkText("SalonLepote"));
            //Act
            homeBtn.Click();
            //Assert
        ...
        [TestMethod]
        public void Testiranje_Navigacije_Na_Stranicu_Za_Dodavanje_Usluge()
        {
            //Arrange
            IWebElement homeBtn = _driver.FindElement(By.LinkText("Dodaj stavku"));
            //Act
            homeBtn.Click();
            //Assert
            Assert.AreEqual($"{baseUrl}SalonLepote/Dodaj", _driver.Url);
        }
        ...
        {
            //Arrange
            IWebElement homeBtn = _driver.FindElement(By.LinkText("Dodaj kategoriju"));
            //Act
            homeBtn.Click();
            //Assert
            Assert.AreEqual($"{baseUrl}SalonLepote/DodajKategoriju", _driver.Url);
        }
        ...
        {
            //Arrange
            _driver.Navigate().GoToUrl($"{baseUrl}SalonLepote/DodajKategoriju");
            ...
            _driver.Navigate().GoToUrl($"{baseUrl}SalonLepote/Dodaj");
        ...
        [TestMethod]
        public void Testiranje_Dodavanja_Stavke_Sa_Ispravnim_Podacima_Popunjava_Tabelu()
        {
            //Arrange
            _driver.Navigate().GoToUrl($"{baseUrl}SalonLepote/Dodaj");
            IWebElement naziv = _driver.FindElement(By.Id("Naziv"));
            ...
            //Assert
            Assert.AreEqual("TestStavka", nazivRezultat.Text);
            Assert.AreEqual("TestKategorija", kategorijaRezultat.Text);
            Assert.AreEqual("20", cenaRezultat.Text);
        }

        [TestMethod]
        public void Testiranje_Dodavanja_Stavke_Sa_Neispravnim_Podacima_Izbacuje_Gresku()
        {
            //Arrange
            _driver.Navigate().GoToUrl($"{baseUrl}SalonLepote/Dodaj");
            IWebElement naziv = _driver.FindElement(By.Id("Naziv"));
        ...
        [TestMethod]
        public void Testiranje_Izmene_Usluge_Sa_Ispravnim_Podacima_Menja_Podatke_U_Tabeli()
        {
            //Arrange
        ...
        [TestMethod]
        public void Testiranje_Izmena_Usluge_Sa_Neispravnim_Podacima_Izbacuje_Gresku()
        {
            //Arrange
            _driver.Navigate().GoToUrl(baseUrl);
            IWebElement izmeniDugme = _driver.FindElement(By.XPath("(//table[1]/tbody/tr)[last()]/td[4]/a"));
        ...
        [TestMethod]
        public void Testiranje_Brisanja_Usluge_Smanjuje_Tabelu()
        {
            //Arrange
            _driver.Navigate().GoToUrl(baseUrl);
